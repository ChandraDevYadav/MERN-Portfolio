    ...
    return (
        <div className='px-24'>
            <div className='text-center py-16'>
                ...
                <h1 className='text-7xl font-bold'>My blog post</h1>
            </div>
            <div className='grid grid-cols-4 gap-4'>
                <div>
                    ...
                    <div className="flex justify-start items-center pr-6 group">
                        <h1 className="text-2xl font-medium pr-8 transition-colors duration-300 group-hover:text-[#ff710b]">
                            Electro-Hub behind development in mobile web design
                        </h1>
                ...
                <div className='mt-8'>
                    ...
                    <div className="flex justify-start items-center pr-6 group">
                        <h1 className="text-2xl font-medium pr-8 transition-colors duration-300 group-hover:text-[#ff710b]">
                            Coffee-Co behind development in mobile web design
                        </h1>
                        <GoArrowUpRight className="text-black text-9xl transition-transform duration-300 group-hover:rotate-45 group-hover:text-[#ff710b]" />
                    </div>
                </div>
                <div>
                    ...
                    <div className="flex justify-start items-center pr-6 group">
                        <h1 className="text-2xl font-medium pr-8 transition-colors duration-300 group-hover:text-[#ff710b]">
                            Hotel-Booking behind development in mobile web design
                        </h1>
                        <GoArrowUpRight className="text-black text-9xl transition-transform duration-300 group-hover:rotate-45 group-hover:text-[#ff710b]" />
                    </div>
                </div>
                <div className='mt-8'>
                    ...
                    <div className="flex justify-start items-center pr-6 group">
                        <h1 className="text-2xl font-medium pr-8 transition-colors duration-300 group-hover:text-[#ff710b]">
                            Gyan-Sagar behind development in mobile web design
                        </h1>
                        <GoArrowUpRight className="text-black text-9xl transition-transform duration-300 group-hover:rotate-45 group-hover:text-[#ff710b]" />
                    </div>
                </div>
