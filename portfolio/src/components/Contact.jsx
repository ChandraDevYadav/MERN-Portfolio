            ...
            <div className='grid grid-cols-3 gap-6'>
                ...
                <div className='border border-white rounded-lg p-6 group text-white'>
                    ...
                    <div className='flex justify-between items-center mt-16'>
                        <Link to='mailto:yadavchandradev4@gmail.com' className='text-xl font-semibold text-[#ff710b]'>yadavchandradev4@gmail.com</Link>
                ...
                <div className='border border-white rounded-lg p-6 group text-white'>
                    ...
                    <div className='flex justify-between items-center mt-16'>
                        <Link to='tel:+977-9805912060' className='text-xl font-semibold text-[#ff710b]'>+977-9805912060</Link>
                        <GoArrowUpRight className="text-white text-4xl transition-transform duration-300 group-hover:rotate-45 group-hover:text-[#ff710b]" />
                    </div>
                </div>
            </div>
